...
public class RandomCourseController {
    ...
    public void initialize() {
        ...
        if (allMusics.isEmpty()) {
            System.err.println("Music List is empty !");
        }
        ...
        playButton.setOnAction(e -> {
            try {
                ...
                if (mainController != null) {
                    mainController.showSaveScoresWithCourse(actualSelectedCourse, actualSelectedDifficulty, false);
                }
            } catch (Exception ex) {
    ...
    private void selectRandomCourse() {
        ...
        if (selection == null) {
            ...
            System.out.println("Found no Course that matched.");
            playButton.setVisible(false);
            return;
        }
        ...
        for (int i = 0; i < musics.size(); i++) {
            ...
            try {
                ...
                System.err.println("Charging jacket for " + music.getTitle() + "is impossible.");
                e.printStackTrace();
            }
        }
    }
